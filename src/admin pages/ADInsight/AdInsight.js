...
const AdInsight = () => {
  ...
  const data = {
    ...
    datasets: [
      {
        data: [approvedReports, deniedReports],
        backgroundColor: ['#FEB010', '#8A252C'],
    ...
    datasets: [
      {
        ...
        data: [20, 30, null, null, null, null, null, null, null, null, null, null],
        backgroundColor: 'rgba(249,65,68,1.00)',
      },
      {
        label: 'Laboratory Accident',
        data: [null, 25, null, null, null, 10, null, null, null, null, null, null],
        backgroundColor: 'rgba(243,114,44,1.00)',
      },
      {
        label: 'Facility-Related Accident',
        data: [10, null, 60, null, null, null, null, null, null, null, null, null],
        backgroundColor: 'rgba(248,150,30,1.00)',
      },
      {
        label: 'Environmental Accident',
        data: [null, null, null, 70, null, null, null, null, null, null, null, null],
        backgroundColor: 'rgba(249,132,74,0.78)',
      },
      {
        label: 'Health-Related Accident',
        data: [null, null, null, null, 40, null, null, null, null, null, null, null],
        backgroundColor: 'rgba(144,190,109,1.00)',
      },
      {
        label: 'Vehicle Accident',
        data: [null, null, null, null, null, 5, null, null, null, null, null, null],
  ...
  return (
    <div className={`WSInsightAnalytics ${isFeedbackVisible ? 'expanded' : 'minimized'}`}>
      <AdNavBar />
            ...
            <div className='PieGroup'>
              ...
              <div className='PercentageContainer'>
                <span 
                  ...
                  style={{ backgroundColor: 'rgba(255, 255, 255, 0.5)', padding: '5px', borderRadius: '5px' }}
                >
                  {approvedPercentage}%
                </span>
                <span 
